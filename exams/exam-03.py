...
def is_perfect(b_tree):
    max_height = b_tree.get_height()
...
# your favorite drink. You may drink as much as you want with the constraint that you cannot drink from 2 adjacent bottles. How can you maximize your intake? Fill the table with columns for the index, volume, and s(v) which is the largest sum so far. 